...
def ensure_dirs(target: Path, class_names: Sequence[str], clean: bool) -> None:
    ...
    split_names = ["train", "val_1", "val_2", "test_1", "test_2"]
    if clean and target.exists():
        for split in split_names + ["val", "test", "test_internal", "test_external"]:
...
def main() -> None:
    ...
    copy_files(o_val_x, o_val_y, "val_1", args.target, class_names, "d1")
    ...
    print("\nResumen:")
    for split in ["train", "val_1", "val_2", "test_1", "test_2"]:
